...
project.config['MAIL_USERNAME'] = os.environ["EMAIL_USERNAME"]
project.config['MAIL_PASSWORD'] = os.environ["EMAIL_PASSWORD"]
project.config['MAIL_DEFAULT_SENDER'] = os.environ["EMAIL_USERNAME"]
